...
namespace Casting_Practice.Services.Interfaces
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public Employee[] Search(Employee[] employess, string searchText)
        {
            return employess.Where(m => m.Name.ToLower().Trim().Contains(searchText.ToLower().Trim()) || m.Surname.ToLower().Trim().Contains(searchText.ToLower().Trim())).ToArray();
        }
    }
}